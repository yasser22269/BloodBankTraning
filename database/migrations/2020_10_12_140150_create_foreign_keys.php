...
class CreateForeignKeys extends Migration {
	...
	public function up()
	{
		...
		Schema::table('donation_reguests', function(Blueprint $table) {
			$table->foreign('client_id')->references('id')->on('clients')
						->onDelete('no action')
						->onUpdate('no action');
		});
		...
		Schema::table('notifications', function(Blueprint $table) {
			$table->foreign('donation_reguest_id')->references('id')->on('donation_reguests')
						->onDelete('no action')
						->onUpdate('no action');
		});
	...
	public function down()
	{
		...
		Schema::table('donation_reguests', function(Blueprint $table) {
			$table->dropForeign('donation_reguests_client_id_foreign');
		});
		Schema::table('donation_reguests', function(Blueprint $table) {
			$table->dropForeign('donation_reguests_city_id_foreign');
		});
		Schema::table('donation_reguests', function(Blueprint $table) {
			$table->dropForeign('donation_reguests_blood_type_id_foreign');
		});
		Schema::table('notifications', function(Blueprint $table) {
			$table->dropForeign('notifications_donation_reguest_id_foreign');
		});
		Schema::table('client_notification', function(Blueprint $table) {
