            ...
            <form role="form" method="POST" action="{{ route('Admin.posts.update',$post->id) }}"enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter title" name="title" value="{{ $post->title}}">
                        @if ($errors->has('title'))
                      ...
                      <div class="form-group">
                        ...
                        <textarea cols="30" rows="10" type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter body" name="body" value="{{ old('body') }}">{{ $post->body}}</textarea>
                        @if ($errors->has('body'))
                        <span class="help-block">
                      ...
                      @if($post->image)
                      <img src="{{ asset('images/Posts/'.$post->image) }}"style='width:100px'class='img-thumbnail' alt="">
                      @endif
                </div>
                <!-- /.card-body -->
