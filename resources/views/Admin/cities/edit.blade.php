...
@section('title', 'edit cities Home')
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <form role="form" method="POST" action="{{ route('Admin.cities.update',$cities->id) }}">
                {{ csrf_field() }}
                {{ method_field('put') }}
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Name" name="name" value="{{ $cities->name}}">
                        @if ($errors->has('name'))
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control select2 select2-hidden-accessible" style="width: 100%;"  tabindex="-1" aria-hidden="true" name="governorate_id" value="{{ old('governorate_id') }}">
                            ...
                            <option value="{{ $governorate->id }}"  {{ $governorate->id == $cities->governorate_id ? "Selected":""  }}  >{{  $governorate->name }}</option>
                            @endforeach
