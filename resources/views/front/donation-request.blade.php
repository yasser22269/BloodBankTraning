                ...
                <div class="path">
                    <nav aria-label="breadcrumb">
                      ...
                      <li class="breadcrumb-item"><a href="{{ route('donation-requests') }}">طلبات التبرع</a></li>
                            <li class="breadcrumb-item active" aria-current="page">طلب التبرع: {{ $donation->client->name }}</li>
                        </ol>
                    </nav>
                </div>
                <div class="details">
